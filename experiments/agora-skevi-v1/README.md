...
propio sellado falla, el staging se conserva para recuperación y se reporta
mediante `recovery_staging`; puede contener digests parciales, pero nunca se
presenta como bundle finalizado ni como evidencia íntegra. La
