"""At most 16 calls, no retries; freeze inputs, code, scoring and protocol first."""
...
shutil.copyfile(root/'docs/revision-comprobaciones-01.md', out/'protocol.md')
protocol = {'max_calls':16,'model':'glm-5.3-flash','temperature':0,'max_output_tokens':8192,
    'max_reserved_output_tokens':131072,'http_and_transport_timeout_seconds':180,'worker_timeout_seconds':200,
    'retries':0,'versions':['v2','v3'],'language':'en','response_format':{'type':'json_object'},'order':'alternate versions by hashed case order',
    ...
    'limits':'four diagnostic pairs; positive means target-axis control; no authentication of external authors, no Spanish/long-document/generalization claims'}
